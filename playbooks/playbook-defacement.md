...
## Playbook: Defacement de sitios web
...
1. Desconecte inmediatamente el servidor con el defacement para investigarlo.
    * Esto es especialmente importante si el defacement es insultante o provocador de algún modo. Elimínelo de la vista del público tan pronto como sea posible para evitar daños, así como para mitigar el impacto del negocio.
    * El mensaje del defacement también puede contener información falsa que podría confundir a los usuarios o ponerlos en peligro.
    * Desconectar el servidor permitirá una investigación más profunda del defacement. Esto puede ser necesario, ya que el hacker puede haberse adentrado en la organización accediendo a servidores de aplicaciones, bases de datos, etc.
...
3. Recoge cualquier pista sobre quién es el hacker o para qué organización trabaja. Considera las siguientes preguntas:
    * ¿Qué representa el defacement? ¿Incluía un mensaje obvio?
...
2. Como se ha mencionado anteriormente, asegúrese de que el servidor de la página que ha sufrido un defacement está temporalmente fuera de servicio mientras se lleva a cabo la investigación.
...
`TODO: Personalizar los pasos de recuperación del defacement`
...
4. Si es necesario y/o aplicable, prepare una disculpa/explicación del ataque ocurrido para los usuarios o cualquier persona que haya presenciado el defacement. Asegúrese de que queda claro que el contenido del defacement no refleja a su organización de ninguna manera. 
...
6. Instala programas de detección de defacements para que, si volviera a producirse un ataque, estés preparado y respondas rápidamente. Aquí hay un [artículo](https://www.techradar.com/news/best-website-defacement-monitoring-service) que resume algunos de los mejores servicios de monitoreo de 2020. 
...
`TODO: Personalizar los pasos de comunicación para el defacement`
...
1. Haz fotos de la página que veas con tu smartphone mostrando las cosas que has notado: el mensaje del defacement y cualquier otro cambio en el sitio habitual.
...
1. Utiliza tu mejor criterio para decidir qué pasos priorizar (por ejemplo, si el defacement dejó contenido dañino o desencadenante, prioriza la retirada del servidor inmediatamente).
1. Pídele al usuario que tome fotos de su pantalla con su smartphone mostrando las cosas que notó.
1. Toma notas sobre el problema o los problemas utilizando la aplicación de notas de voz de tu smartphone o con papel y lápiz. Si se trata de un informe de usuario, haga preguntas detalladas, incluyendo:
    1. ¿Qué has notado?
    1. ¿Cuándo ocurrió por primera vez, y con qué frecuencia desde entonces?
    1. ¿A qué datos suele acceder?
    1. ¿Con quién más se ha puesto en contacto en relación con este incidente y qué le ha dicho?
